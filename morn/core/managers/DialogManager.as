...
package morn.core.managers {
	...
	public class DialogManager extends Sprite {
		...
		public function DialogManager() {
			...
			var bitmap:Bitmap = ObjectUtils.createBitmap(10, 10, 0, 0.4);
			var bitdata:BitmapData = new BitmapData(bitmap.width, bitmap.height);
			bitdata.draw(bitmap);
		...
		private function onResize(e:Event):void {
			...
			for (i = _mask.numChildren - 1; i > -1; i--) {
				...
				if (item) {
					...
					var bitmap:Image = _maskBg.getChildAt(0) as Image;
